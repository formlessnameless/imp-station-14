...
cmd-tippy-help = tippy <user | all> <message> [entity prototype] [speak time] [slide time] [waddle interval] [explode]
...
cmd-tippy-auto-7 = should things end explosively, true or false (default)
